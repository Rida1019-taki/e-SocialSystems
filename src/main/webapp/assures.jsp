...
<head>
    ...
    <title>Gestion des Assurés - e-Social Systems</title>
    <style>
        :root {
        ...
        .btn-update { background-color: var(--accent); color: white; padding: 0.4rem 0.8rem; font-size: 0.85rem; }
        ...
        .modify-salary-form input[type=number] {
            width: 120px;
            padding: 0.4rem;
            flex: none;
        }
...
<nav>
    <ul>
        ...
        <li><a href="assures" class="active">Assurés</a></li>
...
<main>
    <div class="container">
        ...
        <section class="form-card">
            <form method="post" action="assures" class="form-group">
                ...
                <button type="submit" class="btn btn-add">Ajouter Assuré</button>
            </form>
        </section>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Salaire</th>
                    <th>Employeur</th>
                    <th>Actions (Salaire)</th>
                </tr>
            </thead>
            <tbody>
                <c:forEach var="assure" items="${assures}">
                    <tr>
                        <td><strong>#${assure.id}</strong></td>
                        <td>${assure.nom}</td>
                        <td style="font-weight: bold; color: var(--primary-color)">${assure.salaireMensuel} DH</td>
                        <td><span style="background: #e1e8ed; padding: 2px 8px; border-radius: 12px; font-size: 0.9rem;">${assure.employeur.nom}</span></td>
                        <td>
                            <form method="post" action="assures" class="modify-salary-form">
                                <input type="hidden" name="action" value="modifierSalaire">
                                <input type="hidden" name="assureId" value="${assure.id}">
                                <input type="number" step="0.01" name="salaire" placeholder="Nouveau" required>
